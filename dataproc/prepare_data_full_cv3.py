...
def main():
    ...
    python dataproc\prepare_data_full.py ^
        D:\data\chirp3_aoede_9675_to_yoyo\filtered-wavs ^
        D:\data\chirp3_aoede_9675_to_yoyo\filtered-txts ^
        D:\data\chirp3_aoede_9675_to_yoyo\output-cv-data3 ^
        --cv-ratio=0.05 ^
    ...
    python dataproc\prepare_data_full.py ^
        D:\data\Yoyo_pure-mandarin_22k\all_22k_wav_5512_silence-normalized-wavs-dev ^
        D:\data\Yoyo_pure-mandarin_22k\all_22k_wav_5512_silence-normalized-txts-dev ^
        D:\data\Yoyo_pure-mandarin_22k\output_cv_data-dev-test ^
        --cosyvoice-model-dir=D:\models\cosyvoice_models\CosyVoice3-0.5B-2512 ^
        --num-utts-per-parquet=500 ^
        --num-processes=10  --start-from-step=1

    python dataproc\prepare_data_full.py ^
        D:\data\SHC-Lulu-audio\Lulu-Shanghai-wavs-dev ^
        D:\data\SHC-Lulu-audio\Lulu-Shanghai-txts-dev ^
        D:\data\SHC-Lulu-audio\output_cv_data-dev ^
        --cosyvoice-model-dir=D:\models\cosyvoice_models\CosyVoice3-0.5B-2512 ^
        --num-utts-per-parquet=500 ^
        --num-processes=10  --start-from-step=1

    python dataproc\prepare_data_full.py ^
        D:\data\SHC-Lulu-audio\Lulu-Shanghai-wavs-train ^
        D:\data\SHC-Lulu-audio\Lulu-Shanghai-txts-train ^
        D:\data\SHC-Lulu-audio\output_cv_data-train ^
        --cosyvoice-model-dir=D:\models\cosyvoice_models\CosyVoice3-0.5B-2512 ^
        --num-utts-per-parquet=500 ^
        --num-processes=10  --start-from-step=1
    """
